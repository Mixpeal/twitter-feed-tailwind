            ...
            <div className="flex">
                ...
                <div className="w-full">
                    ...
                    <div className="flex mt-4 space-x-8">
                        ...
                        <button className="flex space-x-2 items-center">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.33334 3.33276L3.33334 12.6667C3.33334 14.8758 5.1242 16.6667 7.33334 16.6667L13.3333 16.6667" stroke="#526471" stroke-linecap="round" />
                                <path d="M5.20221 5.10072L3.43445 3.33296L1.66668 5.10073" stroke="#526471" stroke-linecap="round" />
                                <path d="M16.6667 16.6667L16.6667 7.33333C16.6667 5.12419 14.8758 3.33333 12.6667 3.33333L6.66667 3.33333" stroke="#526471" stroke-linecap="round" />
                                <path d="M14.7978 14.8993L16.5656 16.667L18.3333 14.8993" stroke="#526471" stroke-linecap="round" />
                            </svg>
                        ...
                        <button>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.08334 10.4167L2.08334 15.9167C2.08334 17.0213 2.97877 17.9167 4.08334 17.9167L15.9167 17.9167C17.0212 17.9167 17.9167 17.0213 17.9167 15.9167L17.9167 10.4167" stroke="#526471" stroke-linecap="round" />
                                <path d="M13.5606 5.97045L10.0726 2.5708C10.0327 2.53186 9.9686 2.53314 9.93024 2.57364L6.71243 5.97045" stroke="#526471" stroke-linecap="round" />
                                <path d="M10 4L10 16" stroke="#526471" stroke-linecap="round" />
                            </svg>
                        </button>
                    </div>
                </div>
