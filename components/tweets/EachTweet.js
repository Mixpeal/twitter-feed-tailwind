...
export default function EachTweet() {
    return (
        <div className="px-2 lg:px-4 py-5 border-b border-b-border-main cursor-pointer hover:bg-bg-hover">
            <div className="flex">
                <MainAvatar />
                <div className="w-full">
                    <div className="flex space-x-1 lg:space-x-2 items-center justify-between">
                        <div className="flex space-x-1 lg:space-x-2 items-center">
                            <a href="" className="flex space-x-1 lg:space-x-2 items-center hover:underline">
                                <span className="font-semibold text-default-high">Kayode Ojo</span>
                                ...
                                <span className="text-default-medium">@mixpeal</span>
                            </a>
